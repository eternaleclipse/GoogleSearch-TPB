// ==UserScript==
// @name         Google TPB
// @namespace    https://github.com/eternaleclipse/GoogleSearch-TPB
// @version      0.1
// @description  Adds a link to TPB in google search
// @author       EternalEclipse
...
// @match *://www.google.com.lc/*search*
...
if (document.getElementById('lst-ib') != null) {
    setInterval(function() {
        var newSearchValue = document.getElementById('lst-ib').value;

        if (typeof(oldSearchValue) == 'undefined' || oldSearchValue != newSearchValue) {
            var tpbLink = document.getElementById('tpb-link');
            if (tpbLink == null) {
                var linksDiv = document.getElementById('hdtb-msb');
                var tpbDiv = document.createElement('div');
                var lastLink = document.getElementById('hdtb-tls');
                tpbLink = document.createElement('a');
                ...
                tpbDiv.appendChild(tpbLink);
                linksDiv.insertBefore(tpbDiv, lastLink);
            }

            tpbLink.setAttribute('href', 'https://www.thepiratebay.se/search/' + escape(newSearchValue) + '/0/99/0');
            var oldSearchValue = newSearchValue;
        }
    }, 100);
}
